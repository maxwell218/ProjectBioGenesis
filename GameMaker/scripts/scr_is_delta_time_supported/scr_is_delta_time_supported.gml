/// @description Simple helper script to check if delta time is outside of the supported values.  
/// The idea is that if it's outside the supported values, we exit events before anything bad can happen.
